...
class MPU:
    ...
    def compFilter(self):
        ...
        # Print data
        print("angle-Z: " + str(round(self.yaw,1)))
        t=open(r'/home/pi/trye2/11-12/Kalman-Filter-Python-for-mpu6050-master/project/project/project/imu.txt','a')   #打开文件并存储数据
        timestamp = time.time()
        stamp = datetime.datetime.fromtimestamp(timestamp).strftime('%H:%M:%S')
        t.write(str(round(self.yaw,1))+'\n')
        t.write('------------'+'\n')